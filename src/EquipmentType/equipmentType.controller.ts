...
export class EquipmentTypeController {
  ...
  @Get()
  getAllOrFilteredEquipmentTypes(@Query('Types') Types?: string) {
    if (Types) {
      return this.equipmentTypeService.getEquipmentTypeByCategory(Types);
    }
    return this.equipmentTypeService.getAllEquipmentType();
  }
  ...
  updateEquipmentType(
    ...
    @Body() body: Prisma.EquipmentTypeUpdateInput,
  ) {
    return this.equipmentTypeService.updateEquipmentType(id, body);
  }
